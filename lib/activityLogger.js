 ...
 * Note: Activity model removed - this function now just logs to console
...
export async function logActivity({
  ...
  try {
    // Activity logging is now console-only (Activity model removed)
    console.log(`[Activity] ${type}: ${action}`, { employeeId, details, relatedModel, relatedId })
  } catch (error) {
