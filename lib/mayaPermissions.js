...
export function buildRoleBasedFilter(userRole, collection, userId, employeeId, departmentId = null) {
  ...
  if (userRole === 'department_head' && departmentId) {
    ...
    // For other collections, filter by employees in their department
    if (['attendance', 'leave', 'expenses', 'travel', 'payroll', 'performance'].includes(collection)) {
      // This will need to be enhanced with actual department employee lookup
      return filters;
    }
  }
