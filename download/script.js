...
const DOWNLOADS = {
  mac: {
    arm64: {
      url: 'https://github.com/avirajsharma-ops/Talio/releases/download/v1.0.11/Talio-1.0.11-arm64.dmg',
      filename: 'Talio-1.0.11-arm64.dmg',
      label: 'Apple Silicon (M1/M2/M3/M4)',
      size: '~100 MB',
      altLabel: 'Intel (x64)'
    },
    x64: {
      url: 'https://github.com/avirajsharma-ops/Talio/releases/download/v1.0.11/Talio-1.0.11-x64.dmg',
      filename: 'Talio-1.0.11-x64.dmg',
      label: 'Intel (x64)',
      size: '~105 MB',
  ...
  windows: {
    universal: {
      url: 'https://github.com/avirajsharma-ops/Talio/releases/download/v1.0.11/Talio-1.0.11-x64.exe',
      filename: 'Talio-1.0.11-x64.exe',
