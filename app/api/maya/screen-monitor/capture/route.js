...
Be factual and professional. Focus on work-related observations.`
          },
          {
            ...
            content: [
              {
                type: 'text',
                text: `Analyze this employee screen capture and provide a detailed activity summary. Employee: ${monitorLog.targetEmployeeName}, Department: ${monitorLog.targetDepartmentName || 'Unknown'}, Time: ${formatISTDateTime(getCurrentISTDate())}`
              },
              {
                type: 'image_url',
                image_url: {
