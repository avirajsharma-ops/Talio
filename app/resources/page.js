    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col items-center justify-center px-6">
      ...
      <div className="max-w-2xl w-full text-center">
          ...
          <p className="mt-5 text-lg text-gray-400 leading-relaxed">
            Get the native desktop experience for attendance tracking, 
            productivity monitoring, and seamless HR management.
          </p>
            ...
            {selectedOS === 'mac' ? (
              <>
                ...
                <a 
                  ...
                  download
                  className="flex items-center justify-center gap-3 w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-xl font-semibold transition hover:-translate-y-0.5"
                >
              ...
              <>
                <div className="flex justify-between items-center mb-6">
                  ...
                  <span className="bg-blue-600/15 text-blue-500 px-3 py-1.5 rounded-full text-xs font-medium">
                    {arch === 'x64' ? '64-bit (x64)' : '32-bit (x86)'}
                  </span>
                </div>
                <a 
                ...
                >
                  <Download className="w-5 h-5" />
                  Download for Windows ({arch === 'x64' ? '64-bit' : '32-bit'})
                </a>
                <p className="text-center text-gray-500 text-sm mt-3">
                  Installer • ~{arch === 'x64' ? '84' : '74'} MB
                </p>
                <div className="flex justify-center items-center gap-4 mt-5 pt-5 border-t border-[#262626]">
                  <span className="text-gray-500 text-sm">Other versions:</span>
                  {arch === 'x64' && (
                    <a href="/releases/windows/Talio-Setup-1.0.0-ia32.exe" download className="text-blue-500 hover:underline text-sm">32-bit (x86)</a>
                  )}
                  {arch === 'ia32' && (
                    <a href="/releases/windows/Talio-Setup-1.0.0-x64.exe" download className="text-blue-500 hover:underline text-sm">64-bit (x64)</a>
                  )}
                  <a href="/releases/windows/Talio-Portable-1.0.0-x64.exe" download className="text-blue-500 hover:underline text-sm">Portable</a>
                </div>
              </>
            )}
          </div>
